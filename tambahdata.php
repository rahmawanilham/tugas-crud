      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
                ...
                <div class="isi aktif">
                  ...
                  ?>
                    <form action="prosesbiodata.php" method="post">
                        ...
                        <input type="text" name="email" id="emailPribadi" />
                        </div>
                        <div class="form">
                        <p>No KTP</p>
                        <div style="color:red"><?php 
                        ...
                        <P class="">*Setiap mengisi data harap disimpan sebelum lanjut ke pengisian data berikutnya!</P>
            ...
            <!-- mulai alamat -->
                <div class="isi">
                    <form action="prosesalamat.php" method="post">
                    <div class="form">
                      <p>Nim</p>
                      <input type="text" name="nim" value="<?php 
                        if($nim == ""){
                          echo "NIM belum disimpan !";
                        } else {
                          echo $d['nim'];
                        }                    
                      ?>"/>
                ...
                <!-- mulai sekolah -->
                <div class="isi ">
                  <form action="prosessekolah.php" method="post">
                      <div class="form">
                        <p>Nim</p>
                        <input type="text" name="nim" value="<?php 
                            if($nim == ""){
                    ...
                    <div class="form">
                        ...
                        <input type="text" name="alamat_slta">
                    </div>
                    <div class="form">
                        <p>Telepon SMA/SMK</p>
                        <div style="color:red"><?php 
                        ...
                        <input type="text" name="notlp_slta">
                    </div>
                    <button class="btnsimpan" type="submit" name="submit" value="simpan" >Simpan</button>
                </form>
                </div>
